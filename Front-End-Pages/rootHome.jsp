...
<html>
<head>
    <title>Root User Application</title>
...
<body>
    ...
    <p class="sql-instruction">
        ...
        <span class="sql-role-root">root-level</span> user.
        <br>
        Please enter any SQL query or update command in the box below.
    </p>

    <form class="sql-form" action="RootUserApp" method="post">
